This is meant to be a voting tool but its like those minecraft speedrun seed selectors and all

the naming conventions and bassed on the minecraft things not the voting things to make it easyer for me
...
- User votes on a project - `end_seed`
